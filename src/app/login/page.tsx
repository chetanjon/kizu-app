  ...
  return (
    <div className="min-h-screen bg-paper flex items-center justify-center px-6">
      <div className="w-full max-w-[380px]">
        ...
        <div className="bg-surface rounded-[22px] border-[3px] border-ink shadow-[8px_8px_0_var(--color-shadow)] p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 rounded-xl border-[2.5px] border-ink bg-surface font-b font-bold text-[15px] px-6 py-3.5 shadow-[4px_4px_0_var(--color-shadow)] transition-transform duration-100 hover:-translate-x-[1px] hover:-translate-y-[1px] active:translate-x-[3px] active:translate-y-[3px] cursor-pointer"
          >
