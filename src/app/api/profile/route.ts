...
// Set your display name, mute pref, and/or streaming services. Partial updates ok.
export async function PATCH(req: Request) {
  ...
  const update: { name?: string; mute_drop_pings?: boolean; services?: string[]; music_app?: string | null } = {};
