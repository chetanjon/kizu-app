  ...
  return (
    <div className="min-h-screen bg-paper flex items-center justify-center px-6">
      <main className="max-w-[420px] w-full text-center">
        ...
        <Link
          href="/home"
          className="inline-block font-h text-sm font-bold no-underline px-5 py-3 rounded-full border-[2.5px] border-frame bg-vibe text-white shadow-[3px_3px_0_#0D0B09] hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-[4px_4px_0_#0D0B09] transition-transform"
        >
