...
const GLYPH: Record<Action["kind"], string> = { play: "▶", watch: "▷", map: "↗" };
    ...
    <div className={`flex flex-wrap gap-1.5 ${className}`}>
      {actions.map((a, i) => (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-1 font-m text-[10px] font-bold border-[2px] border-ink rounded-full px-2.5 py-1 bg-surface hover:-translate-y-[1px] transition-transform"
        >
