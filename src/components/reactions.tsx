...
export default function Reactions({
  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap relative">
      ...
      {open && (
        <div className="absolute z-30 bottom-8 left-0 flex flex-wrap gap-1 bg-surface border-[2px] border-ink rounded-xl p-2 shadow-[3px_3px_0_var(--color-shadow)] w-[184px]">
          {PALETTE.map((e) => (
